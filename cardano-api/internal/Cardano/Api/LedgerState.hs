                    ...
                    Right newLedgerState -> do
                      let (knownLedgerStates', committedStates) = pushLedgerState env knownLedgerStates slotNo newLedgerState blockInMode
                          ...
                          ledgerStateSingleFold
                            :: (SlotNo, (LedgerState, [LedgerEvent]), WithOrigin (BlockInMode CardanoMode)) -- Ledger events for a single block
                            -> IO FoldStatus
                          ...
                          ledgerStateRecurser
                            :: Seq (SlotNo, LedgerStateEvents, WithOrigin (BlockInMode CardanoMode)) -- Ledger events for multiple blocks
                            -> IO FoldStatus
                      ...
                      case finalFoldStatus of
                        ...
                        DebugFold -> do
                          ...
                          let ioRefErr = Just $ DebugError $ unlines [ "newClientTip: " <> show newClientTip
